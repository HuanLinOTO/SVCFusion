...
class AudioDataset(Dataset):
    def __init__(
        ...
        for name_ext in tqdm(self.paths, total=len(self.paths)):
            name_ext, result = self.get_single_item(name_ext, device, n_spk)
    ...
    def get_single_item(self, name_ext, device, n_spk, load_all_data, fp16):
        ...
        # return (path_audio, duration, f0, volume, spk_id)
    ...
    def get_data(self, name_ext, data_buffer):
        ...
        if audio is None:
            ...
            audio = audio[
                start_frame * self.hop_size : (start_frame + units_frame_len)
                * self.hop_size
            ]
