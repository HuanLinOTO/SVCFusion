    ...
    def update_model(self, model_path):
        ...
        if (
            ...
            self.enhancer = Enhancer(
                self.args.enhancer.type, self.args.enhancer.ckpt, device=self.device
            )
                ...
                sg.Frame(
                    layout=[
                        [
                            sg.Input(
                                key="sg_model",
                                default_text="exp\\multi_speaker\\model_300000.pt",
                            ),
            ...
            [
                sg.Frame(
                    layout=[
                        [
                            sg.Text(i18n("说话人id")),
                            sg.Input(key="spk_id", default_text="1"),
                        ],
                        [
                            sg.Text(i18n("响应阈值")),
                            sg.Slider(
                        ...
                        [
                            sg.Text(i18n("采样率")),
                            sg.Input(key="samplerate", default_text="44100"),
                        ],
                        [
                            sg.Checkbox(
                                text=i18n("启用捏音色功能"),
