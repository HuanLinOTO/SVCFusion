...
from SoVITS.vencoder.encoder import SpeechEncoder
from SoVITS.vencoder.whisper.audio import log_mel_spectrogram, pad_or_trim
from SoVITS.vencoder.whisper.model import ModelDimensions, Whisper
