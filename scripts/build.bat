...
@REM 7za a New-SVCFusion-Preview-0 configs configs_template ddspsvc fap lib Music_Source_Separation_Training SVCFusion ReFlowVaeSVC SoVITS "启动 WebUI.bat" webui.bin dist.cp310-win_amd64.pyd callwt.bat vr.py style.css pretrained ddspsvc_6_1
