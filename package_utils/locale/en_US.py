...
class _Locale(Locale):
    ...
    class main_ui(Locale.main_ui):
        ...
        starting_tip = '"Starting up. Please wait. Do not click again, consequences are severe."'
    ...
    class train(Locale.train):
        ...
        archieve_btn_value = 'Archived work directory'
        stop_btn_value = 'Stop training.'
        archieving_tip = 'Archiving... Do not click multiple times.'
        archieved_tip = 'Archive complete, please check the opened folder.'
    ...
    class settings(Locale.settings):
        ...
        class pkg(Locale.settings.pkg):
            lang_label = 'Language'
            lang_info = 'Language needs to be restarted for the integration package to change.'

        class infer(Locale.settings.infer):
            msst_device_label = 'Run separation task using device.'

        class sovits(Locale.settings.sovits):
            resolve_port_clash_label = 'Try resolving port conflict issues (Windows is applicable)'
    ...
    class vocal_separation(Locale.vocal_separation):
        ...
        job_to_progress_desc = {'Vocal.': 'Silence.', 'kim_vocal': 'Silence.', 'There seems to be a mistake in your request. If you need translation from Chinese to English or any other kind of textual translation service and also want it kept as Markdown format, please provide the text you want translated along with its specific usage context if possible. \n\nFor instance:\n\nInput: 你好。\nResult: Hello.\n\nIn case there are multiple inputs:\n\nInput: 很高兴见到你！欢迎来到我的世界。\nResult: Nice to meet you! Welcome to my world.': 'Go to reverb.', 'Karaoke.': 'Chord out.'}
    ...
    class sovits(Locale.sovits):
        dataset_not_complete_tip = 'The dataset is incomplete, please check the dataset or re-preprocess.'
        finished = 'Done.'
        ...
        class train_main(Locale.sovits.train_main):
            ...
            batch_size_info = 'Larger is better, the larger the more it occupies GPU memory.'
